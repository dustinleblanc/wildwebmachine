...
jQuery(function($){
  ////////////////////////////////
      ...
      jQuery(document).on('click', 'input.select-img', function( event ){
        ...
        var ZaraImage = wp.media.controller.Library.extend({
            defaults :  _.defaults({
                    id:        'zara-insert-image',
        ...
        zara_file_frame = wp.media.frames.zara_file_frame = wp.media({
          button: {
            text: jQuery( this ).data( 'uploader_button_text' )
          },
          state : 'zara-insert-image',
              states : [
                  new ZaraImage()
              ],
        ...
        zara_file_frame.on( 'select', function() {

          var state = zara_file_frame.state('zara-insert-image');
          ...
          // Show in preview.
          var image_preview_wrap = $this.siblings('.zara-preview-wrap');
